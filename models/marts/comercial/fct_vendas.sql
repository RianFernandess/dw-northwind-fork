with
    ...
    , joined as (
        select
            ...
            , pedido_item.desconto_produto
            , pedido_item.preco_da_unidade
            , pedido_item.quantidade_do_produto
            , pedido_item.frete
    ...
    , transformacoes as (
        ...
        *
        , case 
            when desconto_produto > 0 then true 
            when desconto_produto = 0 then false 
            else false 
            end as is_teve_desconto
        , preco_da_unidade * quantidade_do_produto as total_bruto
        , (1 - desconto_produto) * preco_da_unidade * quantidade_do_produto as total_liquido
        from joined
    )
